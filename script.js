...
const lovePhrases = [
    ...
    "لو ألف الدنيا كلها مش هلاقيكِ يا روح قلبي 💖",
    "عניونك أماني ومأمني الوحيد في العالم ده 🥰",
    "بحبك بكل تفاصيلك وبموت في كل حركاتك الطيبة 🌸",
    "أنتِ النعمة اللي أدعي ربنا تديمها عليا للأبد 🙏",
    "حضنك هو المكان الوحيد اللي بحس فيه بالسلام 💫",
    "يا أجمل وردة نورت بستان حياتي وأيامي 🌹",
    "كل ثانية معاكِ بتسوى الدنيا وما فيها يا روحي ❤️",
    "قلبي بينبض باسمك في كل دقيقة وكل ثانية 💞",
    "سندك ومأمنك دايماً ومهما حصل يا فرحة عمري ✨",
    "ضحكتك هي أطهر وأحمل موسيقى سمعتها وداني 🎶",
    "بحب حبك وحنانك اللي بيفيض يملى عليا دنيتي 💖",
    ...
    "مهما طال بيا المسير هفضل واخد عهدي أحميكي بعيوني 🛡️",
